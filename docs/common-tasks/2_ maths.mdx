...
When I imagine of an elegant mathematical idea, I imagine an idea that seems complex to start, but when applied with the necessary steps, it becomes so simple that everybody can understand.
:::

## An elegant maths question

I recently discovered an interesting problem. What does 111,111,111^2 equal?
This problem may seem puzzling and problematic at first, but it really is a simple question.
